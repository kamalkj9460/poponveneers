  ...
  var selectCallback = function(variant, selector) {
	...
	if (variant) {
	  ...
	  if (variant.available) {
		...
		// Compare at price
        // BV - override sale/compare price with discount code tags if active
        if (typeof window.BONFIRE != 'undefined' && typeof window.BONFIRE.tag_discounts_override != 'undefined' && window.BONFIRE.tag_discounts_override.enabled && typeof window.BONFIRE.tag_discounts_override.variant_discounts[variant.id] !== 'undefined') {
          var discount_data = window.BONFIRE.tag_discounts_override.variant_discounts[variant.id];
          $(".js-product-" + productId + " .js-product-price-number").html(
			'<span class="product-' +
			  ...
			  Shopify.formatMoney(variant.price - discount_data.amount, theme.money_format) +
			  "</span></span>"
		  );
          ...
          // BV - show tag discount message 
          $(".js-product-" + productId + " .js-product-price-note").html(discount_data.message);
          ...
          // BV - hide tag discount message 
          $(".js-product-" + productId + " .js-product-price-note").empty();
		} else {
		  $(".js-product-" + productId + " .js-product-price-number").html(
			'<span class="product-' +
			  sectionClass +
